...
export function ShoppingBagIcon({ size = 18, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function StoreIcon({ size = 18, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M2 7h20" />
      <path d="M22 7a3 3 0 0 1-5 2.18A3 3 0 0 1 12 7a3 3 0 0 1-5 2.18A3 3 0 0 1 2 7" />
    </svg>
  );
}
...
export function VerifiedBadgeIcon({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"
      className={`verified-badge-icon ${className}`.trim()}
      title="Verified"
...
export function DoubleCheckIcon({ size = 16, className = "", color = "currentColor" }) {
  return (
...
export function SingleCheckIcon({ size = 16, className = "", color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <polyline points="20 6 9 17 4 12" />
    </svg>
